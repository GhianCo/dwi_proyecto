...
import { ProveedorStore as ProveedorStore } from "../../data-access/proveedor.store";
...
export class ProveedorListComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.searchZonaChanged.pipe(
            ...
            debounceTime(800),
            tap(searchValue => {
                this.proveedorStore.changeQueryInTransportista(searchValue);
            })
        ).subscribe();
    }
    ...
    public changePagination(event: any) {
        this.proveedorStore.changePageInTransportista(event);
    }

    public loadAllStatesFixedAsset() {
        this.proveedorStore.loadAllProveedorStore();
    }
